    ...
    <div id="restaurantes-lista" class="restaurantes-lista flex flex-col gap-3" aria-live="polite">
        ...
        <?php else: ?>
            <?php foreach ($gastronomia as $restaurante): ?>
                ...
                // Usar las rutas de la base de datos o por defecto
                $logo_src = 'assets/img/default-logo.webp';
                if ($restaurante['foto_perfil_url']) {
                    if (file_exists(BASE_PATH . $restaurante['foto_perfil_url'])) {
                        $logo_src = $restaurante['foto_perfil_url'];
                    } elseif (file_exists($restaurante['foto_perfil_url'])) {
                        $logo_src = $restaurante['foto_perfil_url'];
                    }
                }

                $plato_src = 'assets/img/default-plato.webp';
                if ($restaurante['banner_url']) {
                    if (file_exists(BASE_PATH . $restaurante['banner_url'])) {
                        $plato_src = $restaurante['banner_url'];
                    } elseif (file_exists($restaurante['banner_url'])) {
                        $plato_src = $restaurante['banner_url'];
                    }
                }
                ...
                <div class="acordeon <?php echo htmlspecialchars(strtolower(str_replace(' ', '-', $restaurante['subcategoria']))); ?>" 
                    ...
                    <div class="acordeon-header">
                        <img class="acordeon-logo" src="<?php echo $logo_src; ?>" alt="Logo <?php echo htmlspecialchars($restaurante['nombre']); ?>" loading="lazy">
                    ...
                    <div class="acordeon-contenido">
                        <img class="acordeon-imagen" src="<?php echo $plato_src; ?>" alt="<?php echo htmlspecialchars($restaurante['nombre']); ?>" loading="lazy">
